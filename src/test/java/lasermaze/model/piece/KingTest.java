...
public class KingTest {
    ...
    @Test
    public void move() {
        King king = PieceFixture.createKing(Direction.EAST, new Point(4, 1));
    ...
    @Test
    public void rotate2() {
        King king = PieceFixture.createKing(Direction.EAST, new Point(7, 7));
    ...
    @Test
    public void hit() {
        King king = PieceFixture.createKing(Direction.EAST, new Point(7, 0));
